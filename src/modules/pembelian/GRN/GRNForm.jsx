...
import { ArrowLeft, Search, Trash2, MapPin, Users, Plus, FileText, X } from 'lucide-react';
import useTabStore from '../../../store/tabStore';
import Flatpickr from 'react-flatpickr';
import 'flatpickr/dist/l10n/id.js';
import { BrowseSupplierModal, BrowseLokasiModal, BrowsePOModal, PpnDropdown, getSatuanOptions, getDefaultSatuan, isJmlValid, isFloatValid, parseFloatVal } from '../../../lib/formHelpers';
            ...
            <div className="p-5 grid grid-cols-2 gap-4">
              ...
              <div className="col-span-2">
                ...
                <div className="flex items-center gap-2">
                  <div className={`flex-1 flex items-center gap-2 px-3 py-2 rounded-xl border text-sm min-h-[38px] ${idpo ? 'border-primary-100 bg-warm-50/40' : 'border-dashed border-amber-300 bg-amber-50/40'}`}>
                    <FileText className="w-3.5 h-3.5 text-dark-300 shrink-0" />
                    {kodepo
                      ? <span className="font-mono text-dark-500 text-xs">{kodepo}</span>
