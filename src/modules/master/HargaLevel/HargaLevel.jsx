          ...
          <table className="w-full">
            ...
            <tbody>
              {paginatedItems.length === 0 && (
                <tr><td colSpan={5} className="px-4 py-10 text-center text-sm text-dark-300">Belum ada level harga</td></tr>
              )}
              {paginatedItems.map((d) => (
                <tr key={d.idhargajuallevel} className="border-b border-primary-50/50 hover:bg-warm-50/30 text-sm">
                  ...
                  <td className="px-4 py-3">
                    <div className="flex items-center justify-center gap-1">
                      ...
                      {canTambah && (
                        <button onClick={() => handleDelete(d.idhargajuallevel)} className="p-1.5 rounded-lg hover:bg-red-50 text-dark-300 hover:text-red-500">
