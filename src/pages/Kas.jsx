    ...
    <div className="space-y-4">
      ...
      {showForm && (
        <div className="fixed inset-0 bg-black/40 backdrop-blur-sm z-50 flex items-center justify-center p-4" style={{ animation: 'fadeIn 0.2s ease' }}>
          <div className="bg-white rounded-3xl p-6 w-full max-w-2xl shadow-2xl animate-in max-h-[90vh] overflow-y-auto scrollbar-thin">
            <h3 className="text-lg font-bold text-dark-500 mb-4">{editId ? 'Edit' : 'Tambah'} Kas</h3>
